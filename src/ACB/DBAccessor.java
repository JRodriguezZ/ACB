...
//	public void mostraJugadorEquip() throws SQLException, IOException {
...
//	}
//
	public void mostraJugadorsEquip() throws SQLException, IOException {
		Statement st = conn.createStatement();
		Scanner reader = new Scanner(System.in);
		ResultSet rs;

        System.out.println("Equips disponibles:\nF.C. Barecelona\nClub Bàsquet Manresa\nClub Joventut de Badalona\nClub Bàsquet Tarragona\nCroatia\nSpain\n");
		...
		while (rs.next()) {
			System.out.println("Nom: " + rs.getString(2) + "\t| Cognom: " + rs.getString(3) + "\t| Altura: "
					+ rs.getString(6) + "\t| MVP aconseguits: " + rs.getString(8));
		}
